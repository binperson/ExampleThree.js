...
export default {
  ...
  methods: {
    ...
    adjust () {
      ...
      var rightCube = new Mesh(new CubeGeometry(250, 250, 250),
                        new MeshLambertMaterial({color: 0xff0000}));
      rightCube.position.x = 180;
      rightCube.position.y = 180;
      rightCube.castShadow = true
      this.scene.add(rightCube);

      var leftCube = new Mesh(new CubeGeometry(250, 250, 250),
                        new MeshLambertMaterial({color: 0x00ff00}));
      leftCube.position.x = -180;
      leftCube.position.y = 180;
