...
export default {
  ...
  methods: {
    addLights () {
      var light = new DirectionalLight( 0xffffff, 1, 10000 );
      light.position.set( 500, 500, 500 ); 			//default; light shining from top
    ...
    adjust () {
      ...
      var sphereGeometry = new SphereBufferGeometry( 50, 320, 320 );
      var sphereMaterial = new MeshStandardMaterial( { color: 0xff0000 } );
      ...
      var planeGeometry = new PlaneBufferGeometry( 2000, 2000, 320, 320 );
      var planeMaterial = new MeshStandardMaterial( { color: 0x00ff00 } )
